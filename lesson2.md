...
1. 布局美化：canva 不要有非常花哨的设计
2. pdf页数控制到2-3页
3. 格式：文字使用标题或正文，板块之间间隙相同
4. 英文和中文之间需要空格，关键字用粗体表现，检查技术名词拼写

#### 基础信息

1. 姓名、出生日期、岗位、地点、电话、邮箱、github、教育、兴趣爱好
2. 教育：学校名称，不写专业
3. 语言：英语6级
4. 兴趣爱好（最底部）：偏向运动类，健身，骑行爱好者
5. 核心优势：先空
6. skills（首字母大写）：
   - 语言: HTML5, CSS3, JavaScript (ES6+), TypeScript, Node.js , Shell scripting
...
1. s：讲解项目背景
2. t：在项目中的角色，任务目标是什么
3. a：行动，核心部分，解决过最难的技术点，重构需要怎么优化……
4. r：结果，优化的经验，上线的效果
